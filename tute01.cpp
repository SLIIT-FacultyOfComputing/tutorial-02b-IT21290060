...
int main() 
{
    ...
    std::cout << "Enter a length in cm : "; //input length
    std::cin >> cm;   //read length
     
    inches = cm / 2.54;
    std::cout << "Length in inches is" << inches << std::endl; //convert to length given in centimeter to inches
    return 0;
}  
